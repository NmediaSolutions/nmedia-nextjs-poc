    ...
    <>
      ...
      <section className="wrapper py-48">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-48">
          ...
          <ContactForm locale="en" confirmationHref="/en-ca/contact-us/confirmation" />
        </div>
      </section>
      ...
      <section className="bg-beige">
        <div className="wrapper py-96 tablet:py-48">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-32">
            <div>
              <p>1047 Mercure Boulevard<br />Drummondville, Quebec<br />J2B 3L5</p>
              <p>
              ...
              <p className="mt-16">
                Phone number: <a href="tel:+18194770990">819-477-0990</a>
                <br />
                Toll-free: <a href="tel:18664770990">1-866-477-0990</a>
                <br />
                Fax: {c.fax}
                <br />
                Email: <a href="mailto:info@nmedia.ca">info@nmedia.ca</a>
              </p>
            </div>
          </div>
        </div>
