...
/**
 * Ordre et structure des sections calques sur le site source (mesures a 1440px) :
 *  1. banner (hero)                     980px
 *  2. postIntroContent (beige)         1472px  -> expertise IA + 6 lignes de services
 *  3. projectContent                   1081px  -> 2 projets vedettes
 *  4. partnersContent                   413px  -> bandeau de 12 logos
 *  5. contactNbanner                    638px  -> CTA + photo d'equipe
 *  6. careerBanner                      574px  -> carriere + photo bureaux
 *  7. blogContent                       999px  -> 2 articles vedettes
 */
export default function HomePage() {
  return (
    <>
      ...
      {/* 2. Expertise IA (carte doree) + 6 lignes de services — une seule section beige */}
      <section className="bg-beige">
        <div className="wrapper py-120 tablet:py-64">
          ...
          {/* 6 lignes de services : titre a gauche, texte a droite */}
      ...
      <section className="wrapper py-120 tablet:py-64">
        <div className="mb-64 flex flex-col items-start justify-between gap-24 lg:flex-row lg:items-end">          <div className="max-w-reduced">
          ...
          {/* Lien aligne a droite, sous le bloc de titre (cf. .btn.seeAll.abs) */}
          <Link
      ...
      <section className="bg-beige">
        <div className="wrapper py-96 tablet:py-48">
          ...
          <PartnersMarquee partners={content.partners} locale="fr" />
        </div>
      </section>

      {/* 5. CTA — bandeau dore pleine largeur (1440x638), photo a droite */}
      ...
      {/* 6. Carriere — carte noire arrondie inseree (1260px de large, radius 8px) */}
